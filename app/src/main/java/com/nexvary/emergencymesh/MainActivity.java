...
public final class MainActivity extends Activity {
 ...
 @Override protected void onCreate(Bundle b){super.onCreate(b); lang=getSharedPreferences("ui",MODE_PRIVATE).getString("language","ar"); rtl=lang.equals("ar")||lang.equals("ur")||lang.equals("fa"); getWindow().setStatusBarColor(BG);getWindow().setNavigationBarColor(BG);setContentView(build());}
